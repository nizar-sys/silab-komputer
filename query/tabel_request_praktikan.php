...
$q = mysqli_query(mysqli_connect('localhost', 'root', '', 'inventaris'),"select nrp, nama from mahasiswa,praktikum where mahasiswa.id=praktikum.nrp and praktikum.approve='R' and prak='$kategori' and periode='$periode'");
